...
values (nextval(pg_get_serial_sequence('application_parameter', 'id')), 0, 'IS_BATCH_ACTIVE', true);

INSERT INTO APPLICATION_PARAMETER(id, version, parameter, value) 
values (nextval(pg_get_serial_sequence('application_parameter', 'id')), 0, 'LAST_BATCH_UPDATE', null);
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Halvorson, Macejkovic and Reynolds', '194.188.185.80', '8b:c5:59:5b:65:f3', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'BROKEN');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Ankunding, Goldner and Vandervort', '181.30.74.17', 'b3:68:2c:47:b7:53', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Carter, Lehner and Pollich', '106.90.181.128', 'be:dd:72:48:37:4e', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'OFF', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Mills-Jenkins', '5.48.219.39', '48:09:ec:1d:16:d9', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'OFF', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Moen-Wiza', '237.119.105.99', 'af:1c:a6:b6:e0:86', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Trantow and Sons', '210.41.203.247', 'ca:fc:9d:d4:fc:9e', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'BROKEN');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Frami Inc', '209.55.115.47', 'b9:b8:da:9a:56:04', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'OFF', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Ritchie, Leffler and Runolfsson', '82.7.210.60', '3b:9d:ab:48:f2:ee', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'BROKEN');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Kerluke LLC', '228.42.238.16', '6e:c9:eb:ff:74:b4', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'OFF', 'OPERATIONAL');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-16 09:00:00.000', 'BULB', currval(pg_get_serial_sequence('room', 'id')), 'point-9');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Veum Group', '240.224.0.140', '58:81:dd:18:22:f7', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'BROKEN');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-16 09:00:00.000', 'BULB', currval(pg_get_serial_sequence('room', 'id')), 'point-9');
insert into OBJECT_SETTING values(nextval(pg_get_serial_sequence('object_setting', 'id')), 1, currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-09 09:00:00.000');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'McDermott Group', '216.248.249.118', '23:4d:61:ea:f4:ac', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'OFF', 'OPERATIONAL');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-16 09:00:00.000', 'BULB', currval(pg_get_serial_sequence('room', 'id')), 'point-9');
insert into OBJECT_SETTING values(nextval(pg_get_serial_sequence('object_setting', 'id')), 1, currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-09 09:00:00.000');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Dickens, Marquardt and Balistreri', '59.199.158.251', 'ab:45:5d:1d:12:b1', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-16 09:00:00.000', 'BULB', currval(pg_get_serial_sequence('room', 'id')), 'point-9');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Grant and Sons', '162.174.47.187', 'bc:d8:e5:dd:0c:54', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Raynor-Carroll', '200.68.131.65', '01:aa:5d:89:c9:3a', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (currval(pg_get_serial_sequence('connected_object', 'id')), '2019-12-16 09:00:00.000', 'BULB', currval(pg_get_serial_sequence('room', 'id')), 'point-9');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'McCullough-Rau', '72.135.218.203', '80:25:5a:fb:6e:e8', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'OFF', 'OPERATIONAL');
