...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (1, 1, 'Halvorson, Macejkovic and Reynolds', '194.188.185.80', '8b:c5:59:5b:65:f3', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (3, 1, 'Carter, Lehner and Pollich', '106.90.181.128', 'be:dd:72:48:37:4e', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (4, 1, 'Mills-Jenkins', '5.48.219.39', '48:09:ec:1d:16:d9', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (6, 1, 'Trantow and Sons', '210.41.203.247', 'ca:fc:9d:d4:fc:9e', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (7, 1, 'Frami Inc', '209.55.115.47', 'b9:b8:da:9a:56:04', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (8, 1, 'Ritchie, Leffler and Runolfsson', '82.7.210.60', '3b:9d:ab:48:f2:ee', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (9, 1, 'Kerluke LLC', '228.42.238.16', '6e:c9:eb:ff:74:b4', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (10, 1, 'Veum Group', '240.224.0.140', '58:81:dd:18:22:f7', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (11, 1, 'McDermott Group', '216.248.249.118', '23:4d:61:ea:f4:ac', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into CONNECTED_OBJECT (ID, VERSION, BRAND, IP_ADDRESS, MAC_ADDRESS, LAST_MEASUREMENT_DATE, LAST_PARAMETER_MODIFICATION_DATE, STATUS, STATE) values (15, 1, 'McCullough-Rau', '72.135.218.203', '80:25:5a:fb:6e:e8', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');
...
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (5, 5, '2019-12-16 09:00:00.000', 'SUNSHINE_SENSOR', 1, 'point-2');
...
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (7, 1, '2019-12-16 09:00:00.000', 'SMOKE_SENSOR', 1, 'point-4');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (8, 2, '2019-12-16 09:00:00.000', 'DOOR_SENSOR', 2, 'point-door-1');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (9, 3, '2019-12-16 09:00:00.000', 'BULB', 2, 'point-9');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (10, 4, '2019-12-16 09:00:00.000', 'BULB', 3, 'point-9');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (11, 5, '2019-12-16 09:00:00.000', 'BULB', 4, 'point-9');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (12, 6, '2019-12-16 09:00:00.000', 'BULB', 5, 'point-9');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (13, 1, '2019-12-16 09:00:00.000', 'ALARM_CLOCK', 6, 'point-6');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (14, 2, '2019-12-16 09:00:00.000', 'BULB', 6, 'point-9');
insert into NON_MEDICAL_CONNECTED_OBJECT (ID, CONNECTED_OBJECT_ID, INSTALLATION_DATE, NON_MEDICAL_OBJECT_TYPE, ROOM_ID, SVG_POINT) values (15, 3, '2019-12-16 09:00:00.000', 'SMOKE_SENSOR', 6, 'point-10');


-- Creation of the different connected objects type
insert into ALARM_CLOCK values(1,1, '2019-12-09 09:00:00.000' , true);
insert into ALARM_CLOCK values(2,13, '2019-12-09 09:00:00.000' , true);
...
insert into TEMPERATURE_CONTROLLER values(1, 6, 20, 30, 15, 21, true, true, true);
