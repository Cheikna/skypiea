...
values (nextval(pg_get_serial_sequence('connected_object', 'id')), 1, 'Somfy', '192.168.6.1', '80:25:aa:2b:6e:e6', '2019-12-16 09:00:00.000', '2019-12-16 09:00:00.000', 'ON', 'OPERATIONAL');

insert into MEDICAL_CONNECTED_OBJECT values (currval(pg_get_serial_sequence('connected_object', 'id')),(select ID from SKYPIEA_USER where first_name = 'Leo'),'HEART_RATE');
